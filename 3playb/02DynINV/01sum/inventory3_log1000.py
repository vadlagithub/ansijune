...
'''
# USER: Usagr as SCRIPT: ./inventory.py :ansible all -i inventory.py --list-hosts *****
# Run playbook
# JUST LOGGER ENABLED HERE!!!!!!!    **************************************************
# After Exexcution: cat /var/tmp/ansible_dynamic_inventory.log*************************
# To CLEAR LOG :cat /devel/null > /var/tmp/ansible_dynamic_inventory.log **************
